...
==281==    by 0x402158: run_server (in /tmp/tmp5kq8uud0/server)
==281==    by 0x4023B1: main (in /tmp/tmp5kq8uud0/server)
==281==  Address 0xfff000910 is on thread 1's stack
==281==  in frame #1, created by run_server (???:)
==281== 
==281== Syscall param epoll_ctl(event) points to uninitialised byte(s)
==281==    at 0x524AA7A: epoll_ctl (syscall-template.S:84)
==281==    by 0x4021EE: run_server (in /tmp/tmp5kq8uud0/server)
==281==    by 0x4023B1: main (in /tmp/tmp5kq8uud0/server)
==281==  Address 0xfff000448 is on thread 1's stack
==281==  in frame #1, created by run_server (???:)
==281== 
==281== Syscall param epoll_ctl(event) points to uninitialised byte(s)
==281==    at 0x524AA7A: epoll_ctl (syscall-template.S:84)
==281==    by 0x401E48: parse_header (in /tmp/tmp5kq8uud0/server)
==281==    by 0x401E9E: process_client (in /tmp/tmp5kq8uud0/server)
==281==    by 0x402224: run_server (in /tmp/tmp5kq8uud0/server)
==281==    by 0x4023B1: main (in /tmp/tmp5kq8uud0/server)
==281==  Address 0xfff0003e0 is on thread 1's stack
==281==  in frame #1, created by parse_header (???:)
==281== 
==281== 
==281== HEAP SUMMARY:
==281==     in use at exit: 0 bytes in 0 blocks
==281==   total heap usage: 31 allocs, 31 frees, 44,512 bytes allocated
==281== 
